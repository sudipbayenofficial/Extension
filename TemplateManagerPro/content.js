...
function showQuickSaveModal(text, categories) {
    ...
    <style>
        ...
        h3 { margin: 0 0 16px 0; font-size: 16px; color: #6366f1; font-weight: 600; letter-spacing: -0.5px; }
        label { display: block; font-size: 12px; margin-bottom: 6px; font-weight: 500; color: #94a3b8; }
        input, select, textarea {
            ...
            font-size: 13px; font-family: inherit; color: white;
            outline: none;
            transition: 0.2s;
        }
            border-color: #6366f1;
        ...
        option { background-color: #18181b; color: #e2e8f0; }
        ...
        .cancel { background: transparent; border: 1px solid rgba(255, 255, 255, 0.1); color: #e2e8f0; }
        .cancel:hover { background: rgba(255, 255, 255, 0.05); }
        .save { background: #6366f1; color: white; box-shadow: 0 4px 12px rgba(99, 102, 241, 0.3); }
        .save:hover { background: #4f46e5; transform: translateY(-1px); }
    </style>
    <div class="modal">
...
function showFloatingButton(selection) {
    ...
    // Ensure accurate naming to prevent namespace collisions
    floatingBtn.id = 'tmp-float-btn-host';
